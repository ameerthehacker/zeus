...
console.log(sum + product);  // 8 + 8 = 16
```
...
console.log(p.distanceFromOrigin());  // 7
```
...
console.log(bold(red("Hello from the standard library!")));
```
...
console.log(line.length() + p3.x);  // 20 + 10 = 30
```
