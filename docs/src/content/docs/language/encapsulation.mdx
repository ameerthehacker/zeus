...
description: Control access to class internals with public and private, and expose computed properties with get/set accessors.
---
...
Every field and method is either `public` or `private`:
