...
- **Entry Point**: Validates entry modules; `main` function is optional (defaults to exit code 0)
...
| `boolean` | `true`/`false` |
| `void` | Function return only (annotation is optional — omitting `: void` is equivalent) |
