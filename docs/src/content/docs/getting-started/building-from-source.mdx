...
<Aside type="caution">
  The Go LLVM bindings require these environment variables to be set correctly. If you encounter CGO or LLVM-related build errors, double-check that the paths are correct for your system.
</Aside>
