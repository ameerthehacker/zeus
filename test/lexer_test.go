	...
	tests := []struct {
		...
		},
		{
			...
			expected: []*token.Token{
				...
				token.NewToken(token.TokenTypeRightBrace, token.NewSpan(*token.NewPosition(1, 5), *token.NewPosition(1, 5))),
				token.NewToken(token.TokenTypeRightBracket, token.NewSpan(*token.NewPosition(1, 6), *token.NewPosition(1, 6))),
				token.NewToken(token.TokenTypeSemicolon, token.NewSpan(*token.NewPosition(1, 7), *token.NewPosition(1, 7))),
				token.NewToken(token.TokenTypeComma, token.NewSpan(*token.NewPosition(1, 8), *token.NewPosition(1, 8))),
				token.NewToken(token.TokenTypeColon, token.NewSpan(*token.NewPosition(1, 9), *token.NewPosition(1, 9))),
				token.NewToken(token.TokenTypeDot, token.NewSpan(*token.NewPosition(1, 10), *token.NewPosition(1, 10))),
				token.NewToken(token.TokenTypeEOF, token.NewSpan(*token.NewPosition(1, 11), *token.NewPosition(1, 11))),
			},
		},
		{
