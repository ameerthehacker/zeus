...
func (c *CodegenModule) genCast(input ir.CastInstrInput, output zeus_value.Var) {
	...
	case zeus_value.ObjectType:
		// Object type casts (e.g., string<->u8[]) are lowered by the IR lowering pass
		// The output variable already references the result of lowering via renamed variable
		// Just look up the result that was generated by the lowering pass
		result = c.getSymbol(output.Name)
	default:
		panic(castErrorMsg)
	}
